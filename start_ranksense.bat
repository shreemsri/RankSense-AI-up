...
start "TalentScout :: Frontend (Nexi i mt.js)" cmd /k "echo [FRONTEND] Installing packages (first run may take a minute)... && cd frontend && npm install && npm run dev -- --port 3001"
